...
{
    /// <summary>
    /// The host's current rulebook data, as army load sees it (#342). The engine has no idea where
    ...
    /// <summary>
    /// Install point for <see cref="ICurrentRulebook"/> (#342), mirroring how the app installs itself
