...
namespace FDG
{
    public interface ICombatMetadata
    {
        ...
        /// <summary>#376 Bloodthirsty Fighter: true for a follow-up batch generated by block-roll 1s.
        /// The no-chaining guard — AssignWoundsStage refuses to post BonusAttackResults for a batch
        /// that is itself a bonus ("this rule doesn't apply to newly generated attacks").</summary>
        public bool IsBonusAttack => false;

        /// <summary>#376: when set, DetermineHitRollStage rolls exactly this many attack dice instead
        /// of weapon Attacks x WeaponCount — how a bonus batch rolls its (possibly fractional,
        /// histogram-derived) earned count with the REAL weapon, keeping its AP and rules.</summary>
        public float? AttackCountOverride => null;
    ...
    public class CombatMetadata : ICombatMetadata
    {
        ...
        public bool IsBonusAttack { get; private set; }

        public float? AttackCountOverride { get; private set; }
        ...
        public CombatMetadata(IGameContext gameContext, DataBinding<UnitData> attackingUnit,
            ...
            int burstShotIndex = 0, bool isBonusAttack = false, float? attackCountOverride = null)
        {
            ...
            AttackCountOverride = attackCountOverride;
        }
