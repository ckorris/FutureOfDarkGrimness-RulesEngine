namespace FDG.Stages
{
    ...
    /// Normally a shoot fires one queued batch and this falls straight through to morale; a Takedown-split
    ...
    public class DetermineMorePendingShotsStage : StageBase<ICombatActionContext>
    {
            ...
            : base(gameContext, parent)
        {
            ...
            ToMorale = new StageBinding(this);
        }
        ...
        public override async Task Enter(ICombatActionContext context)
        {
            if (context.HasPendingAttack)
            {
                ...
                if (!defenderAlive)
                {
                    ...
                    await ToMorale.Activate(context);
                    return;
                }
